...
ARTNET_REPLY_PARSER = {
    ArtPoll: parse_poll,
    ArtPollReply: parse_poll_reply,
    ArtTrigger: parse_trigger,
    ArtDmx: parse_artdmx,
    ArtNzs: parse_nzs,
    ArtSync: parse_sync,
    ArtIpProg: parse_ip_prog,
    ArtIpProgReply: parse_ip_prog_reply,
    ArtAddress: parse_address,
    ArtCommand: parse_command,
}
...
def pack_ip(
    ...
    op_code = struct.pack("<H", ArtIpProg)
    packet = (
        ART_NET_HEADER
        + op_code
        + ART_NET_VERSION
...
def pack_address(
    ...
    op_code = struct.pack("<H", ArtAddress)
    packet = (
        ART_NET_HEADER
        + op_code
        + ART_NET_VERSION
...
def pack_trigger(key: int, subkey: int, data: bytearray = b"") -> bytes:
    ...
    op_code = struct.pack("<H", ArtTrigger)
    packet = (
        ART_NET_HEADER
        + op_code
        + ART_NET_VERSION
